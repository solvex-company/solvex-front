...
//Desarrolle el navbar para poder navegar entre las diferentes secciones de la aplicación y si recargo no se iria al dashboard.
...
const NavbarAuth = () => {
  ...
  if (isLoading) {
    return <div>Cargando Navbar...</div>; // O un spinner
  }
