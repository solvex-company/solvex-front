...
const Card = (props: CardProps) => {
  return (
    <div
      className={`w-[370px]  h-[465px] p-5 flex flex-col items-center rounded-3xl hover:scale-105 hover:shadow-2xl focus:outline-none hover:ring-4 hover:ring-gray-700 transition-transform duration-300  ${
        props.className ?? ""
      }`}
    >
      <Image
